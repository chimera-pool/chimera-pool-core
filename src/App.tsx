...
const instructionStyles: { [key: string]: React.CSSProperties } = {
  // Protocol Banner
  protocolBanner: { background: 'linear-gradient(180deg, rgba(45, 31, 61, 0.5) 0%, rgba(26, 15, 30, 0.7) 100%)', padding: '24px', borderRadius: '14px', marginBottom: '25px', border: '1px solid rgba(212, 168, 75, 0.3)', textAlign: 'center' },
  protocolBadge: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '12px' },
  v2Badge: { background: 'linear-gradient(135deg, #7B5EA7 0%, #5A3D7A 100%)', color: '#fff', padding: '8px 16px', borderRadius: '20px', fontWeight: 'bold', fontSize: '0.9rem' },
  v1Badge: { background: 'linear-gradient(135deg, #4ADE80 0%, #22C55E 100%)', color: '#1A0F1E', padding: '8px 16px', borderRadius: '20px', fontWeight: 'bold', fontSize: '0.9rem' },
  plusSign: { color: '#D4A84B', fontSize: '1.5rem', fontWeight: 'bold' },
  protocolText: { color: '#B8B4C8', fontSize: '0.95rem', margin: 0, lineHeight: '1.6' },
  // Steps
  stepsContainer: { background: 'linear-gradient(180deg, rgba(13, 8, 17, 0.7) 0%, rgba(26, 15, 30, 0.85) 100%)', padding: '25px', borderRadius: '14px', marginBottom: '25px', border: '1px solid rgba(74, 44, 90, 0.4)' },
  stepsTitle: { color: '#D4A84B', fontSize: '1.15rem', marginTop: 0, marginBottom: '20px', fontWeight: 600 },
  step: { display: 'flex', gap: '15px', marginBottom: '18px', alignItems: 'flex-start' },
  stepNumber: { background: 'linear-gradient(135deg, #D4A84B 0%, #B8923A 100%)', color: '#1A0F1E', width: '36px', height: '36px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: '1rem', flexShrink: 0, boxShadow: '0 2px 8px rgba(212, 168, 75, 0.3)' },
  stepText: { color: '#B8B4C8', fontSize: '0.95rem', margin: '4px 0 0', lineHeight: '1.5' },
  // Connection Box
  connectionBox: { background: 'linear-gradient(180deg, rgba(13, 8, 17, 0.7) 0%, rgba(26, 15, 30, 0.85) 100%)', padding: '25px', borderRadius: '14px', marginBottom: '25px', border: '1px solid rgba(212, 168, 75, 0.3)' },
  connectionTitle: { color: '#D4A84B', fontSize: '1.15rem', marginTop: 0, marginBottom: '20px', fontWeight: 600 },
  copyableBox: { background: 'rgba(26, 15, 30, 0.8)', padding: '18px', borderRadius: '10px', border: '1px solid rgba(74, 44, 90, 0.4)' },
  detailRow: { display: 'flex', flexDirection: 'column', marginBottom: '15px' },
  detailLabel: { color: '#B8B4C8', fontSize: '0.8rem', marginBottom: '6px', textTransform: 'uppercase', letterSpacing: '0.5px', fontWeight: 500 },
  detailCode: { backgroundColor: 'rgba(13, 8, 17, 0.9)', color: '#4ADE80', padding: '12px 16px', borderRadius: '8px', fontFamily: 'monospace', fontSize: '0.95rem', wordBreak: 'break-all', border: '1px solid rgba(74, 44, 90, 0.5)' },
  tipText: { color: '#D4A84B', fontSize: '0.9rem', marginTop: '15px', marginBottom: 0, padding: '12px 16px', background: 'rgba(212, 168, 75, 0.1)', borderRadius: '8px', border: '1px solid rgba(212, 168, 75, 0.2)' },
  // Hardware Section
  hardwareSection: { marginBottom: '25px' },
  hardwareCard: { background: 'linear-gradient(180deg, rgba(13, 8, 17, 0.7) 0%, rgba(26, 15, 30, 0.85) 100%)', borderRadius: '14px', marginBottom: '20px', border: '1px solid rgba(74, 44, 90, 0.4)', overflow: 'hidden', transition: 'all 0.3s ease' },
  hardwareHeader: { display: 'flex', alignItems: 'center', gap: '15px', padding: '20px', background: 'rgba(45, 31, 61, 0.3)', borderBottom: '1px solid rgba(74, 44, 90, 0.4)' },
  hardwareIcon: { fontSize: '2rem' },
  hardwareName: { color: '#F0EDF4', fontSize: '1.05rem', margin: 0, fontWeight: 600 },
  hardwareTag: { display: 'inline-block', background: 'linear-gradient(135deg, #7B5EA7 0%, #5A3D7A 100%)', color: '#fff', padding: '4px 12px', borderRadius: '12px', fontSize: '0.7rem', marginTop: '5px', fontWeight: 600 },
  hardwareTagAlt: { display: 'inline-block', background: 'linear-gradient(135deg, #4ADE80 0%, #22C55E 100%)', color: '#1A0F1E', padding: '4px 12px', borderRadius: '12px', fontSize: '0.7rem', marginTop: '5px', fontWeight: 600 },
  hardwareBody: { padding: '20px' },
  hardwareDesc: { color: '#B8B4C8', fontSize: '0.95rem', margin: '0 0 15px', lineHeight: '1.5' },
  configBox: { background: 'rgba(26, 15, 30, 0.8)', padding: '16px', borderRadius: '10px', marginBottom: '15px', border: '1px solid rgba(74, 44, 90, 0.4)' },
  configCode: { color: '#4ADE80', fontFamily: 'monospace', fontSize: '0.85rem', margin: '10px 0 0', lineHeight: '1.8', whiteSpace: 'pre-wrap' },
  noteText: { color: '#4ADE80', fontSize: '0.9rem', margin: 0, padding: '12px 16px', background: 'rgba(74, 222, 128, 0.1)', borderRadius: '8px', border: '1px solid rgba(74, 222, 128, 0.2)' },
  // Examples
  examplesContainer: { background: 'rgba(13, 8, 17, 0.7)', padding: '20px', borderRadius: '10px', marginBottom: '20px' },
  examplesTitle: { color: '#D4A84B', fontSize: '1.15rem', marginTop: 0, marginBottom: '20px', fontWeight: 600 },
  minerExample: { marginBottom: '20px' },
  minerName: { color: '#D4A84B', fontSize: '0.95rem', marginTop: 0, marginBottom: '10px', fontWeight: 600 },
  commandCode: { display: 'block', background: 'rgba(13, 8, 17, 0.9)', color: '#4ADE80', padding: '14px 16px', borderRadius: '8px', fontFamily: 'monospace', fontSize: '0.8rem', overflowX: 'auto', whiteSpace: 'pre-wrap', wordBreak: 'break-all', border: '1px solid rgba(74, 44, 90, 0.5)' },
  // Troubleshooting
  troubleshootBox: { background: 'linear-gradient(180deg, rgba(13, 8, 17, 0.7) 0%, rgba(26, 15, 30, 0.85) 100%)', padding: '25px', borderRadius: '14px', border: '1px solid rgba(74, 44, 90, 0.4)' },
  troubleshootTitle: { color: '#D4A84B', fontSize: '1.15rem', marginTop: 0, marginBottom: '20px', fontWeight: 600 },
  troubleshootItem: { color: '#F0EDF4', fontSize: '0.95rem', marginBottom: '15px', lineHeight: '1.6', paddingLeft: '12px', borderLeft: '3px solid rgba(212, 168, 75, 0.5)' },
};
